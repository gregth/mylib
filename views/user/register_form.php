        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form id="regForm" method="POST" action="register.php" accept-charset="utf-8" enctype="multipart/form-data" >
                    ...
                    <input class="form-control" id="name" type="text" name="first_name" placeholder="Όνομα" />
                        <span id="errors2"></span>
                    <label for="surname">Επώνυμο</label>
                    <input class="form-control" id="surname" type="text" name="last_name" placeholder="Επώνυμο" />
                        <span id="errors3"></span>
                    <label for="email">E-mail</label>
                    <input class="form-control" id="email" type="text" name="email" placeholder="e-mail" />
                        <span id="errors4"></span>
                    <label for="password">Κωδικός</label>
                    <input class="form-control" id="password" type="password" name="password" placeholder="Κωδικός" />
                        <span id="errors5"></span>
                    <label for="img">Εικόνα προφίλ</label>
                    <input class="form-control" id="img"type="file" name="profileimg" placeholder="Εικόνα προφίλ" />
